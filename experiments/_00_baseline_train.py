...
from _00_baseline_model import GPTConfig, GPT
...
max_iters = 99999999999 # 600000 # total number of training iterations. Set to a large number so that we're bottlenecked by the max duration.
weight_decay = 1e-1
beta1 = 0.9
beta2 = 0.95
