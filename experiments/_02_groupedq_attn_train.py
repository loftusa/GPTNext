...
from _02_groupedq_attn_model import GPTConfig, GPT

parent_dir = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
config_path = os.path.join(parent_dir, 'configurator.py')
data_path = os.path.join(parent_dir, 'data')
name_of_run = "groupedq_attn"
# -----------------------------------------------------------------------------
...
model_args = dict(n_layer=n_layer, n_head=n_head, n_embd=n_embd, block_size=block_size,
                  bias=bias, vocab_size=None, dropout=dropout, n_kv_head=n_kv_head) # start with model_args from command line
...
if wandb_log and master_process:
    ...
    Training details:
    - Dataset: {dataset}
    - Model: {n_layer}L, {n_head}H, {n_kv_head}KV, {n_embd}D
