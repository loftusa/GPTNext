...
from _05_int8_model import GPTConfig, GPT

# -----------------------------------------------------------------------------
# default config values designed to train a gpt2 (124M) on OpenWebText
# I/O
# changes regularly
wandb_run_name = 'int8_quantization' + time.strftime("_%m%d_%H:%M:%S")
...
if init_from == 'scratch':
    ...
    # create the model
    model_args['use_int8'] = use_int8 # Also pass flag when resuming (though state_dict should handle layers)
    gptconf = GPTConfig(**model_args)
    model = GPT(gptconf)
